...
export default function LandingView({ voices, onGoToAuth }: LandingViewProps) {
    ...
    <div className="flex-1 overflow-y-auto bg-[#050505] text-[#e0e0e0]">
      ...
      <div className="relative overflow-hidden bg-[#0a0a0a] border-b border-white/10 py-16 px-8 text-center">
        ...
        <div className="relative z-10 flex flex-wrap justify-center gap-4 mt-8">
          <button onClick={onGoToAuth} className="px-6 py-3 bg-orange-500 hover:bg-orange-600 text-black font-bold rounded-xl text-sm transition-all shadow-[0_0_20px_rgba(242,125,38,0.25)] flex items-center gap-2 cursor-pointer">
            Access Sandbox Environment
            <ArrowRight className="w-4 h-4" />
          </button>
          <a href="#stack-details" className="px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-semibold text-sm rounded-xl transition-all flex items-center gap-2">
      ...
      <div className="max-w-7xl mx-auto px-8 py-12 space-y-16">
        ...
        <div className="max-w-md mx-auto text-center py-8">
          <h3 className="text-white font-semibold text-base mb-3">Ready to try it yourself?</h3>
          <button
            onClick={onGoToAuth}
            className="px-6 py-3 bg-orange-500 hover:bg-orange-600 text-black font-bold rounded-xl text-sm transition-all shadow-[0_0_20px_rgba(242,125,38,0.25)] inline-flex items-center gap-2 cursor-pointer"
          >
